    ...
    <table class="w-full text-xs sm:text-sm text-left rtl:text-right text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-800">
      <thead class="text-xs text-white uppercase" style="background: #6f225e">
        <tr>
          ...
          <th scope="col" class="px-2 sm:px-3 py-2 font-semibold">
            <font-awesome-icon icon="fa-solid fa-users-rectangle" class="mr-1 sm:mr-2 w-3 h-3 sm:w-4 sm:h-4" />
            المادة
          </th>
      ...
      <tbody>
        ...
        >
          ...
          <td class="px-2 sm:px-3 py-2">{{ teacher.FullName }}</td>
            ...
            >
              <ul class="py-2 text-xs sm:text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownMenuIconButton">
                <li>
                  <a
                    href="#"
                    @click.prevent="startEdit(teacher)"
                ...
                <li>
                  <a
                    href="#"
                    @click.prevent="confirmDelete(teacher.id)"
                    class="flex items-center px-3 sm:px-4 py-1.5 sm:py-2 hover:bg-blue-100 dark:hover:bg-gray-600 dark:hover:text-white transition-colors duration-200"
                  >
          ...
          <form @submit.prevent="handleSubmit">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div class="space-y-2 col-span-1 sm:col-span-2">
                ...
                <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">الاسم الرباعي للأستاذ</p>
              </div>
              ...
              <div class="space-y-2">
                ...
                <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">رقم الهاتف الخاص بالأستاذ<span class="text-yellow-600">( * يجب أن يكون 11 رقمًا)</span></p>
              </div>
              ...
              <div class="space-y-2">
                ...
                <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">المعهد الذي ينتمي إليه الأستاذ</p>
              </div>
              ...
              <div class="space-y-2">
                ...
                <div class="relative">
                  <select
                    ...
                    id="subject"
                    class="w-full pl-3 pr-10 py-1.5 sm:py-2 text-xs sm:text-base border rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200"
                    :class="errors.Subject_id ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 dark:border-gray-600 focus:ring-purple-500 focus:border-transparent'"
                  >
              ...
              <div class="space-y-2 col-span-1 sm:col-span-2">
                ...
                <div class="relative">
                  ...
                  />
                  <label for="is_active" class="ml-2 text-xs sm:text-sm text-gray-700 dark:text-gray-300">{{ form.IsActive ? 'نشط' : 'غير نشط' }}</label>
                </div>
                <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">حالة الأستاذ<span class="text-yellow-600">( * في حال كان غير مفعل لن يتمكن من تسجيل الدخول)</span></p>
              </div>
            </div>
          </form>
        </div>
    ...
    <div class="relative w-full max-w-full sm:max-w-md mx-4">
      <div class="relative bg-white dark:bg-gray-800 rounded-xl shadow-2xl overflow-hidden border border-gray-200 dark:border-gray-700 transition-all duration-300 transform scale-95 animate-fade-in">
        ...
        <div class="p-4 sm:p-6 space-y-4 text-center">
          ...
          <h3 class="text-base sm:text-lg font-medium text-gray-900 dark:text-white">هل أنت متأكد من حذف بيانات الأستاذ؟</h3>
          <p class="text-xs sm:text-sm text-gray-600 dark:text-gray-400">
            سيتم حذف جميع البيانات المرتبطة بهذا الأستاذ بشكل دائم، بما في ذلك جميع السجلات والإعدادات الخاصة به.
          </p>
